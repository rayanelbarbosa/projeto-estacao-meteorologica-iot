...
const char* MQTT_HOST     = "SEU_HOST_HIVEMQ.s1.eu.hivemq.cloud";
...
const char* OWM_KEY       = "SUA_API_KEY_OPENWEATHERMAP";
const char* OWM_CITY      = "Suzano,BR";
...
void buscarPrevisao() {
  ...
  if (code == 200) {
    ...
    Serial.print("Sunrise: "); Serial.println(apiSunrise);
    Serial.print("Sunset:  "); Serial.println(apiSunset);
    Serial.print("Dt atual:"); Serial.println(apiDt);
  } else {
    previsao = "Sem dados";
  }
  http.end();
